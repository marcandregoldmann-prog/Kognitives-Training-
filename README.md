...
Wenn nach Updates ein weißer Bildschirm erscheint, in Chrome einmal **Website-Daten löschen** (oder die PWA neu installieren), damit ein alter Service-Worker-Cache sicher ersetzt wird.
